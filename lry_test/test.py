...
def matcher(preds, gts, cost_fns):
    ...
    Returns:
    - matched_row_inds: indices of matched predictions
    - matched_col_inds: indices of matched ground truths
    """
    ...
    matched_row_inds, matched_col_inds = linear_sum_assignment(cost_matrix)
    # shape (num_preds, ) and (num_gts, ) respectively?
