...
from embodiedscan.models.layers import PointFPModule, build_sa_module
from embodiedscan.registry import MODELS
from embodiedscan.utils.typing_config import ConfigType, OptMultiConfig
        ...
        Returns:
            dict[str, list[torch.Tensor]]: Outputs after SA and FP modules.
                ...
                - fp_indices (list[torch.Tensor]): Indices of the
                    input points.
        """
        xyz, features = self._split_point_feats(points) # * B, N, 3 and B, C, N
