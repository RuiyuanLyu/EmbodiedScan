...
test_pipeline = [
    dict(type='LoadAnnotations3D'),
    dict(type='PointCloudPipelineDemo'),
    dict(type='PointSample', num_points=n_points),
    dict(type='Pack3DDetInputs',
         keys=['points', 'gt_bboxes_3d', 'gt_labels_3d'])
]
...
train_dataloader = dict(
    ...
    dataset=dict(type='RepeatDataset',
                 ...
                 dataset=dict(type=dataset_type,
                              ...
                              vg_file='es_gen_text/vg_full/VG_train_flattened_token_positive.json',
                              metainfo=metainfo,
...
val_dataloader = dict(batch_size=12,
                      ...
                      dataset=dict(type=dataset_type,
                                   ...
                                   vg_file='es_gen_text/vg_full/VG_val_5Percent_flattened_token_positive.json',
...
test_dataloader = dict(batch_size=12,
                      ...
                      drop_last=False,
                      sampler=dict(type='DefaultSampler', shuffle=False),
                      dataset=dict(type='PointCloud3DGroundingDatasetDemo',
                                   data_root=data_root,
                                   ann_file='embodiedscan_infos_val.pkl',
                                   vg_file='es_gen_text/vg_single_scene/demo_restroom.json',
                                #    vg_file='es_gen_text/vg_single_scene/scene0094_00_flattened_token_positive.json',
                                   metainfo=metainfo,
                                   pipeline=test_pipeline,
                                   test_mode=True,
                                   filter_empty_gt=True,
...
test_evaluator = dict(type='GroundingMetricMod', format_only=True)
